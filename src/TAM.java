...
public class TAM{
	...
	public TAM(String s,JRadioButton p1,JRadioButton p2, JRadioButton p3,JRadioButton pn, JRadioButton g1,JRadioButton g2, JRadioButton gb3,JRadioButton gn,JRadioButton n1,JRadioButton n2,JRadioButton nn, JRadioButton c1,JRadioButton c2, JRadioButton c3, JRadioButton c4,JRadioButton cn,JRadioButton s1,JRadioButton s2, JRadioButton s3,JRadioButton s4,JRadioButton sn){
    	...
    	final JRadioButton cc1=c1;final JRadioButton cc2=c2;final JRadioButton cc3=c3;;final JRadioButton cc4=c4;final JRadioButton ccn=cn;
    	final JRadioButton ss1=s1;final JRadioButton ss2=s2;final JRadioButton ss3=s3;;final JRadioButton ss4=s4;final JRadioButton ssn=sn;
    	if(none.isSelected()){
		...
		ss1.setEnabled(false);ss2.setEnabled(false);ss3.setEnabled(false);ssn.setSelected(true);}
    		...
    		cc1.setEnabled(true);cc2.setEnabled(true);cc3.setEnabled(true);cc4.setEnabled(true);
    		ss1.setEnabled(true);ss2.setEnabled(true);ss3.setEnabled(true);ss4.setEnabled(true);
    	}
    		...
    		nn1.setEnabled(true);nn2.setEnabled(true);
    		cc1.setEnabled(false);cc2.setEnabled(false);cc3.setEnabled(false);cc4.setEnabled(false);ccn.setSelected(true);
    		ss1.setEnabled(false);ss2.setEnabled(false);ss3.setEnabled(false);ss4.setEnabled(false);ssn.setSelected(true);
    	}
    	else {
