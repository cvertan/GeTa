...
/**
 * builds a class holding all possible correspondences between the Ge'ez and South Arabic letters and their latin transcriptions
 * @author Cristina Vertan
 *
 */
public class InitializeFonts {
   ...
   String[] consonants=	{"h","l","\u1e25","m","\u015b","r","s","q","b","t","\u1e2b","n",
    ...
    private static InitializeFonts instance=null;
    
    public static InitializeFonts getInstance(){
    	if(instance==null) {
    		instance=new InitializeFonts();
    	}
    	return instance;
    }
